# Físca para Computação
Repositório de provas antigas da Disciplina **Físca para Computação** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/fisica-para-computacao.git`
...
`git clone git@github.com:compcederj/fisica-para-computacao.git`
...
# Físca para Computação
Repositório de provas antingas da Disciplina **Físca para Computação** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
